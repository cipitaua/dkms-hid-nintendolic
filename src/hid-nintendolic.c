...
static int ignore_init_failure = 1;
...
static const u32 JC_BTN_A	= BIT(2);
static const u32 JC_BTN_B	= BIT(3);
...
#define jc_type_is_joycon(ctlr) (1==0)
// #define jc_type_is_procon(ctlr) \
// 	(ctlr->hdev->product == USB_DEVICE_ID_NINTENDO_PROCON)
#define jc_type_is_procon(ctlr) (1==1)
// #define jc_type_is_chrggrip(ctlr) \
// 	(ctlr->hdev->product == USB_DEVICE_ID_NINTENDO_CHRGGRIP)
#define jc_type_is_chrggrip(ctlr) (1==0)

/* Does this controller have inputs associated with left joycon? */
// #define jc_type_has_left(ctlr) \
// 	(ctlr->ctlr_type == JOYCON_CTLR_TYPE_JCL || \
// 	 ctlr->ctlr_type == JOYCON_CTLR_TYPE_PRO)
#define jc_type_has_left(ctlr) (1==1)

/* Does this controller have inputs associated with right joycon? */
// #define jc_type_has_right(ctlr) \
// 	(ctlr->ctlr_type == JOYCON_CTLR_TYPE_JCR || \
// 	 ctlr->ctlr_type == JOYCON_CTLR_TYPE_PRO)
#define jc_type_has_right(ctlr) (1==1)
